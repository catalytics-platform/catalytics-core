...
INSERT INTO leaderboard_entries (beta_applicant_id, public_key, total_score, rank, created_at, updated_at)
...
SELECT beta_applicant_id, public_key, total_score, rank, created_at, updated_at
